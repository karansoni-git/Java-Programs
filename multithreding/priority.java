...
public class priority extends Thread {
    ...
    public void run() {
        for (int i = 1; i <= 5; i++) {
            System.out.println(Thread.currentThread().getName() + " - Thread Priority : " + Thread.currentThread().getPriority() + " - Count : " + i); // getPriority() is used see the priority if thread.
            try {
                    Thread.sleep(1000);
            }catch (Exception e){
